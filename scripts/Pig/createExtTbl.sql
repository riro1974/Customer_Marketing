...
location '/user/training/CustMkt/ext/dept';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/class';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/vendor';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/style';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/store';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/cust';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/salesrep';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/promo';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/price_list';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/reason_cd';
...
row format delimited fields terminated by '\t'
location '/user/training/CustMkt/ext/pos';
